...
const KaotoModal = (props: { get: () => Promise<string> }) => {
  ...
  return (
    <React.Fragment>
      <Button variant="secondary" onClick={handleModalToggle} ouiaId="kaoto-button">
        Kaoto
      </Button>
      <Modal
        ...
        actions={[
          <Button key="ok" variant="primary" onClick={handleModalToggle} ouiaId="kaoto-modal-confirm">
            OK
          </Button>,
        ]}
