...
export const KaotoEmptyState = (props: AllProps) => (
  <EmptyState variant={EmptyStateVariant.small}>
    ...
    <EmptyStateBody>
      No Kaoto document has been selected. Please either upload an existing document or create a new one.
    </EmptyStateBody>
...
const FileChooser = (props: UploadProps) => {
  ...
  return (
    <div style={{ marginTop: "var(--pf-c-empty-state__primary--MarginTop)" }}>
      ...
      <input id="file-upload" style={{ display: "none" }} type="file" accept={".yml"} onChange={(e) => showFile(e)} />
    </div>
  );
};
