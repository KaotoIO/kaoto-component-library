...
const StepViews = ({ deleteStep, isPanelExpanded, onClosePanelClick, saveConfig, step, views }: IStepViewsProps) => {
  ...
  return (
    <DrawerPanelContent isResizable id={"right-resize-panel"} defaultSize={"500px"} minSize={"150px"}>
      <DrawerHead>
        <Grid>
          <GridItem span={3}>
      ...
      <DrawerPanelBody>
        <Tabs activeKey={activeTabKey} onSelect={handleTabClick}>
          ...
          {!hasDetailView && (
            <Tab eventKey={detailsTabIndex} title={<TabTitleText>Details</TabTitleText>} data-testid={"detailsTab"}>
              <StepErrorBoundary>
                <br />
                <Grid hasGutter>
                  <GridItem span={3}>
          ...
          <Tab eventKey={configTabIndex} title={<TabTitleText>Config</TabTitleText>} data-testid={"configurationTab"}>
            <br />
            <StepErrorBoundary>
              <Grid hasGutter>
                {step.parameters && (
