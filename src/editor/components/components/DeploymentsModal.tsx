...
import { TableComposable, Thead, Tr, Th, Tbody, Td, ThProps, IAction, ActionsColumn } from "@patternfly/react-table";
...
export const DeploymentsModal = ({ handleCloseModal, isModalOpen }: IDeploymentsModal) => {
  ...
  const [activeSortDirection, setActiveSortDirection] = useState<"asc" | "desc" | undefined>("desc");
      ...
      <Modal
        help={
          <Popover
            ...
            bodyContent={
              <div>
                In the context of software, a <b>deployment</b> encompasses all the processes involved in getting new
