...
export const SettingsModal = ({ handleCloseModal, isModalOpen }: ISettingsModal) => {
  ...
  const [nameValidation, setNameValidation] =
    useState<"default" | "warning" | "success" | "error" | undefined>("default");
  const [namespaceValidation, setNamespaceValidation] =
    useState<"default" | "warning" | "success" | "error" | undefined>("default");
            ...
            labelIcon={
              <Popover
                ...
                bodyContent={
                  <div>
                    <p>
                      The integration type determines what steps you have in the catalog. Not all shown here will be
                      available to you, as it depends on the steps you currently are using.
                    </p>
                    <br />
                    <ul>
                      <li>
                        <b>Kamelets</b>: Choose this if you want to create a connection to be used in an integration.
                        Read more about Kamelets&nbsp;
                        <a
                      ...
                      <li>
                        <b>Camel Routes</b> (advanced): Choose this if you want to create an advanced integration.
                      </li>
                    </ul>
                  </div>
                }
